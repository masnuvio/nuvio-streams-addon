...
builder.defineStreamHandler(async (args) => {
    ...
    try {
        ...
        const streamsByProvider = {
            ...
            'UHDMovies': ENABLE_UHDMOVIES_PROVIDER && shouldFetch('uhdmovies') ? applyAllStreamFilters(providerResults[1], 'UHDMovies', minQualitiesPreferences.uhdmovies, excludeCodecsPreferences.uhdmovies) : [],
            'MoviesMod': ENABLE_MOVIESMOD_PROVIDER && shouldFetch('moviesmod') ? applyAllStreamFilters(providerResults[2], 'MoviesMod', minQualitiesPreferences.moviesmod, excludeCodecsPreferences.moviesmod) : [],
            'TopMovies': ENABLE_TOPMOVIES_PROVIDER && shouldFetch('topmovies') ? applyAllStreamFilters(providerResults[3], 'TopMovies', minQualitiesPreferences.topmovies, excludeCodecsPreferences.topmovies) : [],
            ...
            'StreamFlix': ENABLE_STREAMFLIX_PROVIDER && shouldFetch('streamflix') ? applyAllStreamFilters(providerResults[7], 'StreamFlix', minQualitiesPreferences.streamflix, excludeCodecsPreferences.streamflix) : [],
            'Videasy': ENABLE_VIDEASY_PROVIDER && shouldFetch('videasy') ? applyAllStreamFilters(providerResults[8], 'Videasy', minQualitiesPreferences.videasy, excludeCodecsPreferences.videasy) : [],
            'VidLink': ENABLE_VIDLINK_PROVIDER && shouldFetch('vidlink') ? applyAllStreamFilters(providerResults[9], 'VidLink', minQualitiesPreferences.vidlink, excludeCodecsPreferences.vidlink) : [],
            'NetMirror': ENABLE_NETMIRROR_PROVIDER && shouldFetch('netmirror') ? applyAllStreamFilters(providerResults[10], 'NetMirror', minQualitiesPreferences.netmirror, excludeCodecsPreferences.netmirror) : [],
            'Castle': ENABLE_CASTLE_PROVIDER && shouldFetch('castle') ? applyAllStreamFilters(providerResults[11], 'Castle', minQualitiesPreferences.castle, excludeCodecsPreferences.castle) : []
        };
