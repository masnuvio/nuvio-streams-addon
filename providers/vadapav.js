    ...
    try {
        ...
        elements.each((i, el) => {
            ...
            if (href) {
                ...
                console.log(`[Vadapav Debug] Filename: "${text}"`);
                console.log(`[Vadapav Debug] Parsed: Quality=${details.quality}, Language=${details.language}`);
                console.log(`[Vadapav Debug] Final Title: "${title.replace(/\n/g, '\\n')}"`);
